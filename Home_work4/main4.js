...
let wordsList = function(str, subStr){
  let regex = new RegExp('\\.|,|\\?|!|:|;|"', 'g'); //g - глобально
  ...
  let arr = str
    ...
    .filter((arrItem) => arrItem.indexOf(subStr) > -1);//Метод indexOf() возвращает первый индекс, по которому данный элемент может быть найден в массиве или -1, если такого индекса нет.
